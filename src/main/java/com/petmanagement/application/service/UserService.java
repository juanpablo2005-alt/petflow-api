...
import com.petmanagement.application.port.output.PasswordEncoderPort;
...
public class UserService implements UserUseCase {
    ...
    private final PasswordEncoderPort passwordEncoderPort;  // puerto propio, sin Spring Security

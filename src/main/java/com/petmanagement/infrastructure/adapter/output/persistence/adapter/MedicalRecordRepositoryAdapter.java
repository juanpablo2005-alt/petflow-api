...
public class MedicalRecordRepositoryAdapter implements MedicalRecordRepositoryPort {
    ...
    @Override
    public Flux<MedicalRecord> findByPetIdAndConsultationDateAfter(String petId, LocalDate date) {
        return repository.findByPetIdAndConsultationDateAfter(petId, date).map(this::toDomain);
    }
